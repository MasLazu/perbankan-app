...
public class TransferView extends javax.swing.JPanel {
    ...
    public TransferView(PerbankanApp app) {
        initComponents();
        this.app = app;
    }
    ...
    private void initComponents() {
        ...
        jPanel13Layout.setVerticalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                ...
                .addComponent(jumlah1, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel14Layout.setVerticalGroup(
            ...
            .addGroup(jPanel14Layout.createSequentialGroup()
                ...
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jumlah2, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
                .addContainerGap())
        );

        btnTransfer.setBackground(new java.awt.Color(0, 204, 0));
        btnTransfer.setFont(new java.awt.Font("Poppins SemiBold", 0, 14)); // NOI18N
